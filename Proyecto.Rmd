...
#Only letter
datosIne <- datosIne[-1,]
filtro <- substr(datosIne$caudef, 1, 1)
datosIne <- filter(datosIne, filtro == "V")
param1 <- substr(datosIne$caudef, 2, 2)
param2 <- substr(datosIne$caudef, 3, 3)
param3 <- substr(datosIne$caudef, 4, 4)
