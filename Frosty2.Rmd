...
```{r}
modeloRL<-glm(uno~., data = train[,c(1:17)],family = binomial(link='logit'), maxit=100)
pred<-predict(modeloRL,newdata = test[,c(1:16)], type = "response")
prediccion<-ifelse(pred>=0.5,1,0)
confusionMatrix(test$dos,prediccion)
```
